...
export default function EntryDetailScreen() {
  ...
  const samathInfo = entry.samatha_tendency
    ? SAMATHA_DISPLAY[entry.samatha_tendency]
    : null;
          ...
          >
            ...
            >
              ...
              {moodInfo && (
                <View style={{ alignItems: 'center' }}>
                  ...
                  <Text style={{ color: '#707927', fontSize: 11 }}>
                    {moodInfo.label}
                  </Text>
                </View>
              )}
            ...
            {(samathInfo ||
              ...
              >
                ...
                {entry.hindrance_conditions &&
                  entry.hindrance_conditions.length > 0 && (
                    <View style={{ marginBottom: 8 }}>
                      ...
                      >
                        Conditions that led to hindrance:
                      </Text>
                      <View
                        style={{
                          flexDirection: 'row',
            ...
            {entry.techniques_mentioned &&
              entry.techniques_mentioned.length > 0 && (
                <View style={{ marginTop: 16 }}>
                  <Text
                    style={{ color: '#707927', fontSize: 13, marginBottom: 8 }}
                  >
                    Techniques used
                  </Text>
                  <View
              ...
              entry.progression_signals.length > 0 && (
                ...
                >
                  ...
                  {entry.progression_signals.map((signal, i) => (
                    <Text
                      key={i}
                      style={{ color: '#166534', fontSize: 13, marginTop: 2 }}
                    >
                      • {signal}
                    </Text>
                  ))}
            ...
            {entry.summary && (
              ...
              >
                <Text
                  style={{ color: '#707927', fontSize: 14, marginBottom: 8 }}
                >
                  Summary
                </Text>
                <Text
                  style={{ color: '#3a5222', fontSize: 15, lineHeight: 22 }}
                >
                  {entry.summary}
                </Text>
              </View>
